...
today_price6 = DF['Close'].iloc[-6] # قيمت بسته شدن 6روزقبل
today_price9 = DF['Close'].iloc[-9] # قيمت بسته شدن 6روزقبل
...
today_price_max6 = DF['High'].iloc[-6]     #ب8#
today_price_min6 = DF['Low'].iloc[-6]       #پ8#
today_price_max8 = DF['High'].iloc[-8]     #ب8#
today_price_min8 = DF['Low'].iloc[-8]       #پ8#
today_price_max9 = DF['High'].iloc[-9]     #ب8#
today_price_min9 = DF['Low'].iloc[-9]       #پ8#
...
# بدست آوردن ميانگين 10روزه
ma10 = (math.ceil(average_price))
ma3 = (math.ceil(average_prices7))
Month103_mean = (math.ceil(average_prices4))
