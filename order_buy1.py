...
while True:
    main_menu()
    print ('-'*10)
    user_input = input("Enter 1 ؟ order_buy1.py برنامه راادامه ميدهيدبا \nEnter 2 ياازبرنامه خارج ميشويد؟ : ")
    print ('-'*10)
    print ()
    ...
    if user_input == "2":
        ...
        exit()
          ...
          try:
               ...
               #===================================================
               print ("-"*20,nam,'Signal candlestick patterns:الگوهاي بگشتي')
               ...
               if yesterday_Open_price < today_price and yesterday_price > today_Open_price or yesterday_price_max < today_price and yesterday_price_min > today_Open_price :
                    print ('Bullish Engulfing الگوي برگشتي صعودي معمولادرکف رخميده')
                    print ('buy : الگوي معتبروپرتکراري است براي صعودي ')



               if yesterday_price > today_Open_price and yesterday_Open_price < today_price or yesterday_price_max > today_Open_price and yesterday_price_min < today_price :
                    print ('Bearish Engulfing الگوي برگشتي نزولي معمولا درسقف رخميده')
                    print ('sell : الگوي معتبروپرتکراري است براي نزول')
